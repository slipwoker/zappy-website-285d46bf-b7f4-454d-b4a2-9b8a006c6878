        ...
        contactForm.addEventListener('submit', function(e) {
            ...
            if (isValid) {
                ...
                .catch(function() {
                    ...
                    errorMsg.style.cssText = 'color: #dc3545; padding: 1rem; margin-top: 1rem; text-align: center;';
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '285d46bf-b7f4-454d-b4a2-9b8a006c6878',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '285d46bf-b7f4-454d-b4a2-9b8a006c6878';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '285d46bf-b7f4-454d-b4a2-9b8a006c6878';
